...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, email, handleClick }) => {
    ...
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="block">
          ...
          <h5 className="font-epilogue font-semibold text-[14px] text-white text-left leading-[24px] truncate">{email}</h5>
        ...
        <div className="flex items-center mt-[20px] gap-[12px]">
          <div className="w-[30px] h-[30px] rounded-full flex justify-center items-center bg-[#13131a]">
            <FaEthereum className="w-1/2 h-1/2 object-contain" />
          </div>
